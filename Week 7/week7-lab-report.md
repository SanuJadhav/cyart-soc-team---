# SOC Lab Report – Week 7

## Incident Summary
Suspicious activity detected on host 10.0.2.50 involving repeated failed SSH login attempts followed by abnormal outbound traffic. The SOC team investigated, preserved evidence, and escalated the incident for containment.
...
## Impact Assessment
Potential compromise of host 10.0.2.50 with risk of credential theft and unauthorized access. Outbound traffic suggests possible data exfiltration attempts.
